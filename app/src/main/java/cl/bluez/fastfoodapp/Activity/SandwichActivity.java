...
public class SandwichActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Sandwich barrosluco = new Sandwich("Lomo italiano","bldsgfsjdlksfdf", 3000,R.drawable.lomo);
        Sandwich churrasco = new Sandwich("Churrasco chacarero","bldsgfsjdlksfdf", 2900,R.drawable.churrasco);
        Sandwich pollo = new Sandwich("Pollo con Albondigas","bldsgfsjdlksfdf", 2500,R.drawable.pollo_albonigas);
